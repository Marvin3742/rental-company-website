...
export default withApi({
  ...
  async POST(req) {
    requireAdmin(req);
    const { name, priceCents, image, includesDisplay, badge, tagline, items, sortOrder } = req.body ?? {};
  ...
  async PATCH(req) {
    requireAdmin(req);
    const { id, name, priceCents, image, includesDisplay, badge, tagline, active, items, sortOrder } = req.body ?? {};
